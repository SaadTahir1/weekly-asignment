...
let school = 'The City School';
let branches_school = 3;
let school_cleanliness = false;
let miXed = 'it is true that i am 16 years old';
let nullPizza = null;
let b;
...
// example(5) Arrays :
// Array => 0..,[]
let friend_list = ['Osama', 'Ahmed', 'Ali'];
console.log(friend_list);
// for mix data types:
let user_n = ['Ijaz', 23, false];
console.log(user_n);
...
let fruitBucket = ['grape', 'apple', 'mango'];
